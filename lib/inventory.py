...
class InventoryWindow(tk.Frame, ThemeEngine):
    ...
    def __init__(self, master):
        ...
        graph_button = tk.Button(product_menu_frame, text="Create Graphs", command=self.create_graphs)
        graph_button.place(x=37, y=410)
...
##============================== OTHER METHODS ===================================================##
    ...
    def create_graphs(self):
        ...
        data = self.db_obj.get_product_details('%')
        ...
        graph_window.title("Inventory Graphs")
